...
enum class render_option : GLenum
{
    blend = GL_BLEND,
...
{
    if constexpr (std::same_as<Type, GLfloat>)
        return type_value::gl_float;
    else if constexpr (std::same_as<Type, GLdouble>)
        return type_value::gl_double;
    else if constexpr (std::same_as<Type, GLbyte>)
        return type_value::gl_byte;
    else if constexpr (std::same_as<Type, GLshort>)
        return type_value::gl_short;
    else if constexpr (std::same_as<Type, GLint>)
        return type_value::gl_int;
    else if constexpr (std::same_as<Type, GLubyte>)
        return type_value::gl_ubyte;
    else if constexpr (std::same_as<Type, GLushort>)
        return type_value::gl_ushort;
    else if constexpr (std::same_as<Type, GLuint>)
        return type_value::gl_uint;
}
