...
public:
    ...
    template<concepts::trivially_copyable_data_range R>
    void storage(R&& r, buffer_storage_flags flags) const noexcept(noexcept(std::ranges::data(r)))
    {
        storage(std::ranges::data(r), std::ranges::size(r), sizeof(std::ranges::range_value_t<R>), flags);
    }
    ...
    {
        sub_data(std::ranges::data(r), std::ranges::size(r), sizeof(std::ranges::range_value_t<R>), offset);
    }
...
public:
    ...
    {
        glNamedBufferStorage(static_cast<GLuint>(m_handle.get()),
                             static_cast<GLsizeiptr>(std::ranges::ssize(r) * sizeof(value_type)),
                             std::ranges::data(r),
                             static_cast<GLbitfield>(flags));
    }
    ...
    {
        glNamedBufferStorage(static_cast<GLuint>(m_handle.get()),
                             static_cast<GLsizeiptr>(sizeof(value_type)),
                             &data,
                             static_cast<GLbitfield>(flags));
    }
    ...
    {
        auto* ptr = static_cast<value_type*>(glMapNamedBufferRange(static_cast<GLuint>(m_handle.get()),
                                                                   static_cast<GLintptr>(offset * sizeof(value_type)),
                                                                   static_cast<GLsizeiptr>(count * sizeof(value_type)),
                                                                   static_cast<GLbitfield>(flags)));
