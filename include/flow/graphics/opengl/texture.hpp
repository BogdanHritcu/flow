...
namespace gl {
    ...
    namespace detail {
        ...
        [[nodiscard]] constexpr std::size_t texture_dimensions(texture_type type) noexcept
        {
            ...
            case texture_type::texture2D:         return 2;
            case texture_type::texture1D_array:   return 2;
            case texture_type::texture_rectangle: return 2;
            case texture_type::texture3D:         return 3;
        ...
        public:
            ...
            // clang-format off
            using deleter_type = decltype([](id_type id) { glDeleteTextures(1, &id); });
            // clang-format on
            using handle_type = unique_handle<id_type, deleter_type>;

        public:
            constexpr basic_texture()
                : m_handle{}
            {}
        ...
        public:
            ...
            void storage(size_type mipmap_levels, texture_format format, size_type width, size_type height, size_type depth) const noexcept
            {
    ...
    {
    public:
        using id_type = detail::basic_texture<detail::texture_dimensions(Type)>::id_type;
        using size_type = detail::basic_texture<detail::texture_dimensions(Type)>::size_type;
