...
namespace concepts {
    ...
    template<typename T>
    concept serializer = std::invocable<make_lval_ref_t<ostream_view>, make_const_lval_ref_t<T>>;

    template<typename T>
    concept deserializer = std::invocable<make_lval_ref_t<istream_view>, make_lval_ref_t<T>>;
